...
void Pipe::SpawnPipe(cocos2d::Layer * layer) {
	...
	topPipeBody->setCollisionBitmask(OBSTACLE_COLLLISTION_BITMASK);
	bottomPipeBody->setCollisionBitmask(OBSTACLE_COLLLISTION_BITMASK);
	...
	pointBody->setCollisionBitmask(POINT_COLLLISTION_BITMASK);
