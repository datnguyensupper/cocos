...
void SoundController::CreateSoundControl(cocos2d::Layer * layer) {
	...
	ToggleButton * soundBtn = ToggleButton::create("sprites/maingame/play_bg.png","sprites/maingame/mute_bg.png", "sprites/maingame/play_bg.png", "sprites/maingame/mute_bg.png");
