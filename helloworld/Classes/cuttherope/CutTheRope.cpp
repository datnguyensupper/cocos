...
CCScene* CutTheRope::scene()
{
    // 'scene' is an autorelease object
    CCScene *scene = CCScene::create();
    
    // 'layer' is an autorelease object
	CutTheRope *layer = CutTheRope::create();
...
bool CutTheRope::init()
{
	...
	candies = new std::vector<b2Body*>;

	ropeSpriteSheet = CCSpriteBatchNode::create("Images/rope_texture.png");
	...
	// Add the background
	cocos2d::CCSprite *background = cocos2d::CCSprite::create("bg.png");
	background->setAnchorPoint(Vec2::ZERO);
	this->addChild(background,-1);

	// Add the croc
	croc_ = cocos2d::CCSprite::create("croc_front_mouthclosed.png");
	...
	this->scheduleOnce(schedule_selector(CutTheRope::fakeTich), 3);
    return true;
}

void CutTheRope::initPhysics()
{
...
b2Body* CutTheRope::createCandyAt(CCPoint pt,bool userData)
{
	// Get the sprite from the sprite sheet
	cocos2d::CCSprite* sprite = cocos2d::CCSprite::create("pineapple.png");
...
void CutTheRope::createRopeD(b2Body* bodyA,b2Vec2 anchorA,b2Body* bodyB,b2Vec2 anchorB,float32 sag)
{
	b2RopeJointDef jd;
	jd.bodyA = bodyA;
	jd.bodyB = bodyB;
...
//Scheduling...
void CutTheRope::update(float dt)
{
...
//Check intersection..
bool CutTheRope::checkLineIntersection(cocos2d::CCPoint p1,cocos2d::CCPoint p2,cocos2d::CCPoint p3,cocos2d::CCPoint p4)	//Watch Out!!..Class::
{
...
//Touches...
//void CutTheRope::ccTouchesMoved(CCSet* touches, CCEvent* event)
//{
//	CCSize s = CCDirector::sharedDirector()->getWinSize();
//
...
void CutTheRope::fakeTich(float dt)
{
	...
	CCPoint pt0 = CCPoint(visibleSize.width/2,10);
	CCPoint pt1 = CCPoint(0, 0);				//Watch Ot!!..locationInView() has no argument..
...
b2Body* CutTheRope::createRopeTipBody()
{
	b2BodyDef bodyDef;
	bodyDef.type = b2_dynamicBody;
...
void CutTheRope::menuCloseCallback(CCObject* pSender)
{
